...
(function() {
  ...
  leaflegend = function() {
    return L.LeafLegend = L.Class.extend({
      ...
      makeGrid: function() {
        var $palettes, bez, cell_width, cl1, cl2, color1, color2, cols1, colurs, colurschema1, colurschema2, colurschema3, colurschema4, colurseq, colursstatements, gdc, gdrow, grid_size, grid_size_effective, gridwidth, gutter_width, height, highlightCell, i, icreament_size, j, leg_el, legend_el, m, n, pallets, rectGrid, rects, steps, width, x, x_size, xintervalSize, xintervals, xsize, y_size, yintervalSize, yintervals, ysize, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
